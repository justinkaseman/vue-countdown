<template>
  <div id="lampadario">
    ...
    <div id="lampadina">
      <div id="sorpresa">
        <Countdown id="app" end="May 3, 2019"/>
      </div>
    </div>
  </div>
</template>
...
body {
  ...
  background: -webkit-gradient(
    left top,
    left bottom,
    color-stop(0%, rgb(184, 90, 144)),
    color-stop(73%, rgb(54, 30, 42)),
    color-stop(100%, rgb(24, 13, 19))
  );
